...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.minusscalar0_second = torch.nn.Parameter(torch.from_numpy(__weights_dict['minusscalar0_second']['value']), requires_grad=False)
        self.mulscalar0_second = torch.nn.Parameter(torch.from_numpy(__weights_dict['mulscalar0_second']['value']), requires_grad=False)

        relus = []
        keys = ['relu0', 'stage1_unit1_relu1', 'stage1_unit2_relu1',
                'stage1_unit3_relu1', 'stage2_unit1_relu1', 'stage2_unit2_relu1',
                'stage2_unit3_relu1', 'stage2_unit4_relu1', 'stage2_unit5_relu1',
                'stage2_unit6_relu1', 'stage2_unit7_relu1', 'stage2_unit8_relu1',
                'stage2_unit9_relu1', 'stage2_unit10_relu1',
                'stage2_unit11_relu1', 'stage2_unit12_relu1',
                'stage2_unit13_relu1', 'stage3_unit1_relu1', 'stage3_unit2_relu1',
                'stage3_unit3_relu1', 'stage3_unit4_relu1', 'stage3_unit5_relu1',
                'stage3_unit6_relu1', 'stage3_unit7_relu1', 'stage3_unit8_relu1',
                'stage3_unit9_relu1', 'stage3_unit10_relu1',
                'stage3_unit11_relu1', 'stage3_unit12_relu1',
                'stage3_unit13_relu1', 'stage3_unit14_relu1',
                'stage3_unit15_relu1', 'stage3_unit16_relu1',
                'stage3_unit17_relu1', 'stage3_unit18_relu1',
                'stage3_unit19_relu1', 'stage3_unit20_relu1',
                'stage3_unit21_relu1', 'stage3_unit22_relu1',
                'stage3_unit23_relu1', 'stage3_unit24_relu1',
                'stage3_unit25_relu1', 'stage3_unit26_relu1',
                'stage3_unit27_relu1', 'stage3_unit28_relu1',
                'stage3_unit29_relu1', 'stage3_unit30_relu1',
                'stage4_unit1_relu1', 'stage4_unit2_relu1', 'stage4_unit3_relu1']
        for idx, key in enumerate(keys):
            w = __weights_dict[key]['weights']
            prelu = torch.nn.PReLU(w.shape[0])
            prelu.state_dict()['weight'].copy_(torch.from_numpy(w))
            relus.append(prelu)
            self.__setattr__(f'relu%03d'%idx, prelu)
        self.relus = relus
    ...
    def forward(self, x):
        ...
        conv0_pad       = F.pad(x, (1, 1, 1, 1))
        conv0           = self.conv0(conv0_pad)
        bn0             = self.bn0(conv0)
        relu0           = self.relus[ind](bn0)#F.prelu(bn0, torch.from_numpy(__weights_dict['relu0']['weights']))
        ind += 1
        ...
        stage1_unit1_relu1 = self.relus[ind](stage1_unit1_bn2)#, torch.from_numpy(__weights_dict['stage1_unit1_relu1']['weights']))
        ind += 1
        ...
        stage1_unit2_relu1 = self.relus[ind](stage1_unit2_bn2)#, torch.from_numpy(__weights_dict['stage1_unit2_relu1']['weights']))
        ind += 1
        ...
        stage1_unit3_relu1 = self.relus[ind](stage1_unit3_bn2)#, torch.from_numpy(__weights_dict['stage1_unit3_relu1']['weights']))
        ind += 1
        ...
        stage2_unit1_relu1 = self.relus[ind](stage2_unit1_bn2)#, torch.from_numpy(__weights_dict['stage2_unit1_relu1']['weights']))
        ind += 1
        ...
        stage2_unit2_relu1 = self.relus[ind](stage2_unit2_bn2)#, torch.from_numpy(__weights_dict['stage2_unit2_relu1']['weights']))
        ind += 1
        ...
        stage2_unit3_relu1 = self.relus[ind](stage2_unit3_bn2)#, torch.from_numpy(__weights_dict['stage2_unit3_relu1']['weights']))
        ind += 1
        ...
        stage2_unit4_relu1 = self.relus[ind](stage2_unit4_bn2)#, torch.from_numpy(__weights_dict['stage2_unit4_relu1']['weights']))
        ind += 1
        ...
        stage2_unit5_relu1 = self.relus[ind](stage2_unit5_bn2)#, torch.from_numpy(__weights_dict['stage2_unit5_relu1']['weights']))
        ind += 1
        ...
        stage2_unit6_relu1 = self.relus[ind](stage2_unit6_bn2)#, torch.from_numpy(__weights_dict['stage2_unit6_relu1']['weights']))
        ind += 1
        ...
        stage2_unit7_relu1 = self.relus[ind](stage2_unit7_bn2)#, torch.from_numpy(__weights_dict['stage2_unit7_relu1']['weights']))
        ind += 1
        ...
        stage2_unit8_relu1 = self.relus[ind](stage2_unit8_bn2)#, torch.from_numpy(__weights_dict['stage2_unit8_relu1']['weights']))
        ind += 1
        ...
        stage2_unit9_relu1 = self.relus[ind](stage2_unit9_bn2)#, torch.from_numpy(__weights_dict['stage2_unit9_relu1']['weights']))
        ind += 1
        ...
        stage2_unit10_relu1 = self.relus[ind](stage2_unit10_bn2)#, torch.from_numpy(__weights_dict['stage2_unit10_relu1']['weights']))
        ind += 1
        ...
        stage2_unit11_relu1 = self.relus[ind](stage2_unit11_bn2)#, torch.from_numpy(__weights_dict['stage2_unit11_relu1']['weights']))
        ind += 1
        ...
        stage2_unit12_relu1 = self.relus[ind](stage2_unit12_bn2)#, torch.from_numpy(__weights_dict['stage2_unit12_relu1']['weights']))
        ind += 1
        ...
        stage2_unit13_relu1 = self.relus[ind](stage2_unit13_bn2)#, torch.from_numpy(__weights_dict['stage2_unit13_relu1']['weights']))
        ind += 1
        ...
        stage3_unit1_relu1 = self.relus[ind](stage3_unit1_bn2)#, torch.from_numpy(__weights_dict['stage3_unit1_relu1']['weights']))
        ind += 1
        ...
        stage3_unit2_relu1 = self.relus[ind](stage3_unit2_bn2)#, torch.from_numpy(__weights_dict['stage3_unit2_relu1']['weights']))
        ind += 1
        ...
        stage3_unit3_relu1 = self.relus[ind](stage3_unit3_bn2)#, torch.from_numpy(__weights_dict['stage3_unit3_relu1']['weights']))
        ind += 1
        ...
        stage3_unit4_relu1 = self.relus[ind](stage3_unit4_bn2)#, torch.from_numpy(__weights_dict['stage3_unit4_relu1']['weights']))
        ind += 1
        ...
        stage3_unit5_relu1 = self.relus[ind](stage3_unit5_bn2)#, torch.from_numpy(__weights_dict['stage3_unit5_relu1']['weights']))
        ind += 1
        ...
        stage3_unit6_relu1 = self.relus[ind](stage3_unit6_bn2)#, torch.from_numpy(__weights_dict['stage3_unit6_relu1']['weights']))
        ind += 1
        ...
        stage3_unit7_relu1 = self.relus[ind](stage3_unit7_bn2)#, torch.from_numpy(__weights_dict['stage3_unit7_relu1']['weights']))
        ind += 1
        ...
        stage3_unit8_relu1 = self.relus[ind](stage3_unit8_bn2)#, torch.from_numpy(__weights_dict['stage3_unit8_relu1']['weights']))
        ind += 1
        ...
        stage3_unit9_relu1 = self.relus[ind](stage3_unit9_bn2)#, torch.from_numpy(__weights_dict['stage3_unit9_relu1']['weights']))
        ind += 1
        ...
        stage3_unit10_relu1 = self.relus[ind](stage3_unit10_bn2)#, torch.from_numpy(__weights_dict['stage3_unit10_relu1']['weights']))
        ind += 1
        ...
        stage3_unit11_relu1 = self.relus[ind](stage3_unit11_bn2)#, torch.from_numpy(__weights_dict['stage3_unit11_relu1']['weights']))
        ind += 1
        ...
        stage3_unit12_relu1 = self.relus[ind](stage3_unit12_bn2)#, torch.from_numpy(__weights_dict['stage3_unit12_relu1']['weights']))
        ind += 1
        ...
        stage3_unit13_relu1 = self.relus[ind](stage3_unit13_bn2)#, torch.from_numpy(__weights_dict['stage3_unit13_relu1']['weights']))
        ind += 1
        ...
        stage3_unit14_relu1 = self.relus[ind](stage3_unit14_bn2)#, torch.from_numpy(__weights_dict['stage3_unit14_relu1']['weights']))
        ind += 1
        ...
        stage3_unit15_relu1 = self.relus[ind](stage3_unit15_bn2)#, torch.from_numpy(__weights_dict['stage3_unit15_relu1']['weights']))
        ind += 1
        ...
        stage3_unit16_relu1 = self.relus[ind](stage3_unit16_bn2)#, torch.from_numpy(__weights_dict['stage3_unit16_relu1']['weights']))
        ind += 1
        ...
        stage3_unit17_relu1 = self.relus[ind](stage3_unit17_bn2)#, torch.from_numpy(__weights_dict['stage3_unit17_relu1']['weights']))
        ind += 1
        ...
        stage3_unit18_relu1 = self.relus[ind](stage3_unit18_bn2)#, torch.from_numpy(__weights_dict['stage3_unit18_relu1']['weights']))
        ind += 1
        ...
        stage3_unit19_relu1 = self.relus[ind](stage3_unit19_bn2)#, torch.from_numpy(__weights_dict['stage3_unit19_relu1']['weights']))
        ind += 1
        ...
        stage3_unit20_relu1 = self.relus[ind](stage3_unit20_bn2)#, torch.from_numpy(__weights_dict['stage3_unit20_relu1']['weights']))
        ind += 1
        ...
        stage3_unit21_relu1 = self.relus[ind](stage3_unit21_bn2)#, torch.from_numpy(__weights_dict['stage3_unit21_relu1']['weights']))
        ind += 1
        ...
        stage3_unit22_relu1 = self.relus[ind](stage3_unit22_bn2)#, torch.from_numpy(__weights_dict['stage3_unit22_relu1']['weights']))
        ind += 1
        ...
        stage3_unit23_relu1 = self.relus[ind](stage3_unit23_bn2)#, torch.from_numpy(__weights_dict['stage3_unit23_relu1']['weights']))
        ind += 1
        ...
        stage3_unit24_relu1 = self.relus[ind](stage3_unit24_bn2)#, torch.from_numpy(__weights_dict['stage3_unit24_relu1']['weights']))
        ind += 1
        ...
        stage3_unit25_relu1 = self.relus[ind](stage3_unit25_bn2)#, torch.from_numpy(__weights_dict['stage3_unit25_relu1']['weights']))
        ind += 1
        ...
        stage3_unit26_relu1 = self.relus[ind](stage3_unit26_bn2)#, torch.from_numpy(__weights_dict['stage3_unit26_relu1']['weights']))
        ind += 1
        ...
        stage3_unit27_relu1 = self.relus[ind](stage3_unit27_bn2)#, torch.from_numpy(__weights_dict['stage3_unit27_relu1']['weights']))
        ind += 1
        ...
        stage3_unit28_relu1 = self.relus[ind](stage3_unit28_bn2)#, torch.from_numpy(__weights_dict['stage3_unit28_relu1']['weights']))
        ind += 1
        ...
        stage3_unit29_relu1 = self.relus[ind](stage3_unit29_bn2)#, torch.from_numpy(__weights_dict['stage3_unit29_relu1']['weights']))
        ind += 1
        ...
        stage3_unit30_relu1 = self.relus[ind](stage3_unit30_bn2)#, torch.from_numpy(__weights_dict['stage3_unit30_relu1']['weights']))
        ind += 1
        ...
        stage4_unit1_relu1 = self.relus[ind](stage4_unit1_bn2)#, torch.from_numpy(__weights_dict['stage4_unit1_relu1']['weights']))
        ind += 1
        ...
        stage4_unit2_relu1 = self.relus[ind](stage4_unit2_bn2)#, torch.from_numpy(__weights_dict['stage4_unit2_relu1']['weights']))
        ind += 1
        ...
        stage4_unit3_relu1 = self.relus[ind](stage4_unit3_bn2)#, torch.from_numpy(__weights_dict['stage4_unit3_relu1']['weights']))
        ind += 1
        ...
        return fc1 / fc1.norm(dim=1, keepdim=True)
